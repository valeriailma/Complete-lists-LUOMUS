...
showGamma = T #Default: showGamma = FALSE, convergence not shown for gamma-parameters
showOmega = T #Default: showOmega = FALSE, convergence not shown for Omega-parameters
...
pdf(file= file.path(resultDir,"/MCMC_convergence_2.pdf"))
if(showBeta){
  par(mfrow=c(2,1))
